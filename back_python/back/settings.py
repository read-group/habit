...
WX={
  ...
  'WX_AUTH_URL_CODE':"https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&{redirect_uri}&response_type=code&scope=snsapi_userinfo&state={state}#wechat_redirect" % ('wx8f428820d2150a9e'),
