...
WX={
  ...
  'WX_APP_REDIRECT':'http://192.168.2.107:8000/mobile/main?role={role}',
  'WX_AUTH_URL_CODE':"https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri={redirect_uri}&response_type=code&scope=snsapi_userinfo&#wechat_redirect" % ('wx8f428820d2150a9e'),
