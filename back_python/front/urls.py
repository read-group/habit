...
urlpatterns = [
    ...
    url(r'^main/grain/feedback/note.*$', GrainFeedbackNoteView.as_view(),name="main.grain.feedbacknote"),
    url(r'^main/grain/feedback/.*$', GrainFeedbackView.as_view(),name="main.grain.feedback"),
