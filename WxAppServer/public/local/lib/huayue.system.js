...
//		 * 删除字典内的对象的方法
	...
	huayue.object = huayue.utils.extend(null,null, {
		/**
		 * 这个方法需要被重写
		 */
		ctor : function() {
		...
		New : function() {
			...
			if(arguments.length==0){
				child=huayue.utils.extend(null,null,null);
			}
			if(arguments.length==1){
				if(typeof arguments[0]!="object")
					throw new Error("param must be type of object");
				child=huayue.utils.extend(null,this, arguments[0]);
			}
			if(arguments.length==2){
				child=huayue.utils.extend(arguments[0],this, arguments[1]);
			}		
		...
		Abstract:function(){
			...
			if(arguments.length==0){
				child=huayue.utils.extend(null,null,null,true);
			}
			if(arguments.length==1){
				if(typeof arguments[0]!="object")
					throw new Error("param must be type of object");
				child=huayue.utils.extend(null,this, arguments[0],true);
			}
			if(arguments.length==2){
				child=huayue.utils.extend(arguments[0],this, arguments[1],true);
			}
